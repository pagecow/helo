            ...
            <div id='dashboard'>
                ...
                {postList.map(post => 
                    <div id='post-box'>
                        ...
                        <button onClick={() => {this.handleDelete(post.post_id); this.newGetRequest()}} className='post-delete-button'>Delete Post</button>
                    </div>
                )}
                </div>
            </div>
