    ...
    return(
        <div>
            <div className='sign-up-page'>
                    ...
                    <p className='step-one-sub-header'>Helo</p>

                    <div>
                        <input onChange={e => setEmail(e.target.value)} type='email' className='sign-up-inputs' placeholder="Email Address"/>
                            {error ? (<p className='signup-error-message'>Email address not valid.</p>): (null)}
                        <br/>
                        <input onChange={e => setPassword(e.target.value)} type="password" className='sign-up-inputs' placeholder="Password"/>
                            {error ? (<p className='signup-error-message'>Password must have at least 8 characters.</p>): (null)}
